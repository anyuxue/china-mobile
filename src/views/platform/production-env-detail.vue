<template>
    <div class="table-type-4">
        ...
        <jt-row style="" class="total-attr">
            ...
            <jt-col :span="3">
                <span class='total-attr-totalGPS'> {{totalGPS}}</span>
            </jt-col>
            <jt-col :span="3">
                <span class='total-attr-totalPeakGps'>{{totalPeakGps}}</span>
            </jt-col>
            <jt-col :span="3">
                <span class='total-attr-totalPeakGpsNum'>{{totalPeakGpsNum}}</span>
            </jt-col>
        </jt-row>
...
export default {
    ...
    data: () => ({
        typeAColumns: [
            ...
            {title: '生产环境调用量', dataIndex: 'flow', key: 'flow', className:"col-att"},
            {title: '日均GPS', dataIndex: 'gps', key: 'gps', className:"col-att"},
            {title: '峰值GPS', dataIndex: 'peakGps', key: 'peakGps', className:"col-att"},
            {title: '峰值GPS次数', dataIndex: 'peakGpsNum', key: 'peakGpsNum', className:"col-att"}
        ],
        typeADataSrc: [],
        typeADataShow: [],
        typeACurrentPage: 1,
    ...
    methods:{
        initTypical1(){
            this.typeADataSrc = [
                {id: 'ID000001', name: '中国移动智能机器人', flow: 1000, gps:10, peakGps:100, peakGpsNum:100},
                {id: 'ID000002', name: '中国移动智能机器人', flow: 1000, gps:10, peakGps:100, peakGpsNum:100},
                {id: 'ID000003', name: '中国移动智能机器人', flow: 1000, gps:10, peakGps:100, peakGpsNum:100},
                {id: 'ID000004', name: '中国移动智能机器人', flow: 1000, gps:10, peakGps:100, peakGpsNum:100},
                {id: 'ID000005', name: '中国移动智能机器人', flow: 1000, gps:10, peakGps:100, peakGpsNum:100},
                {id: 'ID000006', name: '中国移动智能机器人', flow: 1000, gps:10, peakGps:100, peakGpsNum:100},
                {id: 'ID000007', name: '中国移动智能机器人', flow: 1000, gps:10, peakGps:100, peakGpsNum:100},
                {id: 'ID000008', name: '中国移动智能机器人', flow: 1000, gps:10, peakGps:100, peakGpsNum:100},
                {id: 'ID000009', name: '中国移动智能机器人', flow: 1000, gps:10, peakGps:100, peakGpsNum:100},
                {id: 'ID000010', name: '中国移动智能机器人', flow: 1000, gps:10, peakGps:100, peakGpsNum:100},
                {id: 'ID000011', name: '中国移动智能机器人', flow: 1000, gps:10, peakGps:100, peakGpsNum:100},
                {id: 'ID000012', name: '中国移动智能机器人', flow: 1000, gps:10, peakGps:100, peakGpsNum:100},
                {id: 'ID000013', name: '中国移动智能机器人', flow: 1000, gps:10, peakGps:100, peakGpsNum:100},
                {id: 'ID000014', name: '中国移动智能机器人', flow: 1000, gps:10, peakGps:100, peakGpsNum:100},
                {id: 'ID000015', name: '中国移动智能机器人', flow: 1000, gps:10, peakGps:100, peakGpsNum:100},
                {id: 'ID000016', name: '中国移动智能机器人', flow: 1000, gps:10, peakGps:100, peakGpsNum:100},
                {id: 'ID000017', name: '中国移动智能机器人', flow: 1000, gps:10, peakGps:100, peakGpsNum:100},
                {id: 'ID000018', name: '中国移动智能机器人', flow: 1000, gps:10, peakGps:100, peakGpsNum:100},
                {id: 'ID000019', name: '中国移动智能机器人', flow: 1000, gps:10, peakGps:100, peakGpsNum:100},
            ...
            for (let i = 0; i < this.typeADataSrc.length; i++) { 
                ...
                this.totalPeakGps =  this.typeADataSrc[i].peakGps + this.totalPeakGps,
                this.totalPeakGpsNum =  this.typeADataSrc[i].peakGpsNum + this.totalPeakGpsNum
            }
        },
