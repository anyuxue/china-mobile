    ...
    <div class="wrapper">
        ...
        <section class="content">
            <div class="content-wrap" v-show="pageIndex == 0">
                ...
                <div class="mid-card">
                    <div class="mid-card-1" @mouseenter="onMouseOver" @mouseleave="onMouseout">
                        <div style="margin: 16px 16px 0 17px;">
                            ...
                            <span style="
                                ...
                                line-height: 20px;"
                            >闲聊</span>
                            <span class="btn-stop" v-if = 'show' @click="showModal">
                    ...
                    <div class="mid-card-2" @mouseenter="onMouseOver" @mouseleave="onMouseout">
                        <div style="margin: 16px 16px 0 17px;">
                            <span><jt-icon type="message" /></span>
                            <span style="
                                margin-left: 10px;
                    ...
                    <div class="mid-card-3" @mouseenter="onMouseOver" @mouseleave="onMouseout">
                        <div style="margin: 16px 16px 0 17px;">
                            <span><jt-icon type="message" /></span>
                            <span style="
                                margin-left: 10px;
                    ...
                    <div class="mid-card-4" @mouseenter="onMouseOver" @mouseleave="onMouseout">
                        <div style="margin: 16px 16px 0 17px;">
                            <span><jt-icon type="message" /></span>
                            <span style="
                                margin-left: 10px;
                    ...
                    <div class="mid-card-5" @mouseenter="onMouseOver" @mouseleave="onMouseout">
                        <div style="margin: 16px 16px 0 17px;">
                            <span><jt-icon type="message" /></span>
                            <span style="
                                margin-left: 10px;
                            ...
                            <div class="options">
                                <div style="margin: 16px 16px 0 17px;">
                                    ...
                                    <span style="float: right;">
                                        <jt-switch defaultunChecked checkedChildren="开" unCheckedChildren="关" />
                                    </span>
                                </div>
                                <div style="margin: 8px 31px 16px 17px;">
                                    <span style="
