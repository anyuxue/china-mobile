<template>
    <div class="content">
        <jt-button type="primary" @click="showDrawer">Show Drawer</jt-button>
        <jt-drawer
            title="请选择要添加的预置技能"
            :width="721"
            :drawerStyle="{
        ...
        >
                    ...
                    <div class="options">
                        <div style="margin: 16px 16px 0 17px;">
                            ...
                            <span style="float: right;">
                                <jt-switch defaultChecked checkedChildren="开" unCheckedChildren="关" />
                            </span>
                        </div>
            ...
            <div class="drawerFooter">
                ...
                <jt-button :style="{ width: '80px', height: '32px' }" type="primary">确定</jt-button>
            </div>
        </jt-drawer>
    </div>
</template>
